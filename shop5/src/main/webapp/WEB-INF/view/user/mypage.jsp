...
<c:if test="${param.id != 'admin' }"><td id="tab2" class="tab"><a href="javascript:disp_div('oinfo','tab2')">주문정보보기</a></td></c:if>
</tr>
</table>
...
<td align="right"><fmt:formatNumber value="${sale.total }" pattern="#,###"></fmt:formatNumber>원</td>
</tr>
...
<td><fmt:formatNumber value="${saleItem.item.price }" pattern="#,###"></fmt:formatNumber>원</td>
<td>${saleItem.quantity }개</td>
<td><fmt:formatNumber value="${saleItem.item.price * saleItem.quantity }"></fmt:formatNumber>원</td>
</tr>
</c:forEach>
</table>
</td>
